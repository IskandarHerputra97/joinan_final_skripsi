...
class VideoDetail10 extends StatefulWidget {

  final Video video;
  VideoDetail10({Key key, @required this.video}) : super(key: key);

  @override
  _VideoDetail10State createState() => _VideoDetail10State();
}

class _VideoDetail10State extends State<VideoDetail10> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/y2mate.com - belajar_java_tipedata_string_7YKbO2bhNl4_360p.mp4');
