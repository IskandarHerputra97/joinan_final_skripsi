...
class VideoDetail6 extends StatefulWidget {

  final Video video;
  VideoDetail6({Key key, @required this.video}) : super(key: key);

  @override
  _VideoDetail6State createState() => _VideoDetail6State();
}

class _VideoDetail6State extends State<VideoDetail6> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/Belajar Java (Tipe-Data-Angka).mp4');
