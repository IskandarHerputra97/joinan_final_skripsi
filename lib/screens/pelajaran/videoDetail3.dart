...
class VideoDetail3 extends StatefulWidget {
  ...
  final Video video;
  VideoDetail3({Key key, @required this.video}) : super(key: key);

  @override
  _VideoDetail3State createState() => _VideoDetail3State();
}

class _VideoDetail3State extends State<VideoDetail3> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/Belajar Java (Komentar).mp4');
