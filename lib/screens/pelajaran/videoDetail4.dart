...
class VideoDetail4 extends StatefulWidget {

  final Video video;
  VideoDetail4({Key key, @required this.video}) : super(key: key);

  @override
  _VideoDetail4State createState() => _VideoDetail4State();
}

class _VideoDetail4State extends State<VideoDetail4> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/Belajar Java (Operator Matematik).mp4');
