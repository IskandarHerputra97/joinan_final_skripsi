...
class VideoDetail5 extends StatefulWidget {

  final Video video;
  VideoDetail5({Key key, @required this.video}) : super(key: key);

  @override
  _VideoDetail5State createState() => _VideoDetail5State();
}

class _VideoDetail5State extends State<VideoDetail5> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/Belajar Java (Struktur Dasar).mp4');
