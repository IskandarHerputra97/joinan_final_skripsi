...
class VideoDetail7 extends StatefulWidget {

  final Video video;
  VideoDetail7({Key key, @required this.video}) : super(key: key);

  @override
  _VideoDetail7State createState() => _VideoDetail7State();
}

class _VideoDetail7State extends State<VideoDetail7> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/Belajar Java (Variabel).mp4');
