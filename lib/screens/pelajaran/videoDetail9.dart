...
class VideoDetail9 extends StatefulWidget {

  final Video video;
  VideoDetail9({Key key, @required this.video}) : super(key: key);

  @override
  _VideoDetail9State createState() => _VideoDetail9State();
}

class _VideoDetail9State extends State<VideoDetail9> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/y2mate.com - belajar_java_operator_matermatik2_g22Khk7gZbQ_360p.mp4');
