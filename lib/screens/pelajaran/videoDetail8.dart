...
class VideoDetail8 extends StatefulWidget {

  final Video video;
  VideoDetail8({Key key, @required this.video}) : super(key: key);

  @override
  _VideoDetail8State createState() => _VideoDetail8State();
}

class _VideoDetail8State extends State<VideoDetail8> {
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset('assets/y2mate.com - belajar_java_kelas_dan_paket_YZbDIiEBE_M_360p.mp4');
